...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/helpers.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/helpers.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/</a> &#187; helpers.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function validateClose(open, close) {</span>
<span class="cstat-no" title="statement not covered" >  close = close.path ? close.path.original : close;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (open.path.original !== close) {</span>
<span class="cstat-no" title="statement not covered" >    var errorNode = { loc: open.path.loc };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new _exception2['default'](open.path.original + " doesn't match " + close, errorNode);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function SourceLocation(source, locInfo) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function id(token) {</span>
<span class="cstat-no" title="statement not covered" >  if (/^\[.*\]$/.test(token)) {</span>
<span class="cstat-no" title="statement not covered" >    return token.substr(1, token.length - 2);</span>
  } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function stripComment(comment) {</span>
<span class="cstat-no" title="statement not covered" >  return comment.replace(/^\{\{~?\!-?-?/, '').replace(/-?-?~?\}\}$/, '');</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function preparePath(data, parts, loc) {</span>
<span class="cstat-no" title="statement not covered" >  loc = this.locInfo(loc);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var original = data ? '@' : '',</span>
      dig = [],
      depth = 0,
      depthString = '';
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!isLiteral &amp;&amp; (part === '..' || part === '.' || part === 'this')) {</span>
<span class="cstat-no" title="statement not covered" >      if (dig.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        throw new _exception2['default']('Invalid path: ' + original, { loc: loc });</span>
...
<span class="cstat-no" title="statement not covered" >        depthString += '../';</span>
      }
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function prepareMustache(path, params, hash, open, strip, locInfo) {</span>
  // Must use charAt to support IE pre-10
<span class="cstat-no" title="statement not covered" >  var escapeFlag = open.charAt(3) || open.charAt(2),</span>
      escaped = escapeFlag !== '{' &amp;&amp; escapeFlag !== '&amp;';
&nbsp;
<span class="cstat-no" title="statement not covered" >  var decorator = /\*/.test(open);</span>
<span class="cstat-no" title="statement not covered" >  return {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function prepareRawBlock(openRawBlock, contents, close, locInfo) {</span>
<span class="cstat-no" title="statement not covered" >  validateClose(openRawBlock, close);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  locInfo = this.locInfo(locInfo);</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function prepareBlock(openBlock, program, inverseAndProgram, close, inverted, locInfo) {</span>
<span class="cstat-no" title="statement not covered" >  if (close &amp;&amp; close.path) {</span>
<span class="cstat-no" title="statement not covered" >    validateClose(openBlock, close);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var decorator = /\*/.test(openBlock.open);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  program.blockParams = openBlock.blockParams;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var inverse = undefined,</span>
      inverseStrip = undefined;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (inverseAndProgram) {</span>
<span class="cstat-no" title="statement not covered" >    if (decorator) {</span>
<span class="cstat-no" title="statement not covered" >      throw new _exception2['default']('Unexpected inverse block on decorator', inverseAndProgram);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (inverseAndProgram.chain) {</span>
<span class="cstat-no" title="statement not covered" >      inverseAndProgram.program.body[0].closeStrip = close.strip;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    inverseStrip = inverseAndProgram.strip;</span>
<span class="cstat-no" title="statement not covered" >    inverse = inverseAndProgram.program;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (inverted) {</span>
<span class="cstat-no" title="statement not covered" >    inverted = inverse;</span>
<span class="cstat-no" title="statement not covered" >    inverse = program;</span>
<span class="cstat-no" title="statement not covered" >    program = inverted;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function prepareProgram(statements, loc) {</span>
<span class="cstat-no" title="statement not covered" >  if (!loc &amp;&amp; statements.length) {</span>
<span class="cstat-no" title="statement not covered" >    var firstLoc = statements[0].loc,</span>
        lastLoc = statements[statements.length - 1].loc;
&nbsp;
    /* istanbul ignore else */
<span class="cstat-no" title="statement not covered" >    if (firstLoc &amp;&amp; lastLoc) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function preparePartialBlock(open, program, close, locInfo) {</span>
<span class="cstat-no" title="statement not covered" >  validateClose(open, close);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return {</span>
