...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/compiler.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/compiler.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">8.02% <small>(21 / 262)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric">2 statements, 4 branches</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/</a> &#187; compiler.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable new-cap */
&nbsp;
'use strict';
&nbsp;
...
Compiler.prototype = {
  compiler: Compiler,
&nbsp;
  equals: <span class="fstat-no" title="function not covered" >function equals(other) {</span>
...
<span class="cstat-no" title="statement not covered" >      if (opcode.opcode !== otherOpcode.opcode || !argEquals(opcode.args, otherOpcode.args)) {</span>
<span class="cstat-no" title="statement not covered" >        return false;</span>
      }
    }
&nbsp;
...
&nbsp;
  guid: 0,
&nbsp;
  compile: <span class="fstat-no" title="function not covered" >function compile(program, options) {</span>
<span class="cstat-no" title="statement not covered" >    this.sourceNode = [];</span>
...
<span class="cstat-no" title="statement not covered" >    this.stringParams = options.stringParams;</span>
<span class="cstat-no" title="statement not covered" >    this.trackIds = options.trackIds;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    options.blockParams = options.blockParams || [];</span>
&nbsp;
    // These changes will propagate to the other compiler components
<span class="cstat-no" title="statement not covered" >    var knownHelpers = options.knownHelpers;</span>
<span class="cstat-no" title="statement not covered" >    options.knownHelpers = {</span>
      'helperMissing': true,
...
<span class="cstat-no" title="statement not covered" >      for (var _name in knownHelpers) {</span>
        /* istanbul ignore else */
<span class="cstat-no" title="statement not covered" >        if (_name in knownHelpers) {</span>
<span class="cstat-no" title="statement not covered" >          options.knownHelpers[_name] = knownHelpers[_name];</span>
        }
      }
    }
&nbsp;
...
&nbsp;
  compileProgram: <span class="fstat-no" title="function not covered" >function compileProgram(program) {</span>
<span class="cstat-no" title="statement not covered" >    var childCompiler = new this.compiler(),</span>
...
<span class="cstat-no" title="statement not covered" >    this.useDepths = this.useDepths || result.useDepths;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return guid;</span>
  },
&nbsp;
  accept: <span class="fstat-no" title="function not covered" >function accept(node) {</span>
    /* istanbul ignore next: Sanity code */
<span class="cstat-skip" title="statement not covered" >    if (!this[node.type]) {</span>
<span class="cstat-skip" title="statement not covered" >      throw new _exception2['default']('Unknown type: ' + node.type, node);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.sourceNode.unshift(node);</span>
<span class="cstat-no" title="statement not covered" >    var ret = this[node.type](node);</span>
<span class="cstat-no" title="statement not covered" >    this.sourceNode.shift();</span>
<span class="cstat-no" title="statement not covered" >    return ret;</span>
  },
&nbsp;
  Program: <span class="fstat-no" title="function not covered" >function Program(program) {</span>
<span class="cstat-no" title="statement not covered" >    this.options.blockParams.unshift(program.blockParams);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var body = program.body,</span>
        bodyLength = body.length;
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; bodyLength; i++) {</span>
<span class="cstat-no" title="statement not covered" >      this.accept(body[i]);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.options.blockParams.shift();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.isSimple = bodyLength === 1;</span>
<span class="cstat-no" title="statement not covered" >    this.blockParams = program.blockParams ? program.blockParams.length : 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  },
&nbsp;
  BlockStatement: <span class="fstat-no" title="function not covered" >function BlockStatement(block) {</span>
<span class="cstat-no" title="statement not covered" >    transformLiteralToPath(block);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var program = block.program,</span>
        inverse = block.inverse;
&nbsp;
<span class="cstat-no" title="statement not covered" >    program = program &amp;&amp; this.compileProgram(program);</span>
<span class="cstat-no" title="statement not covered" >    inverse = inverse &amp;&amp; this.compileProgram(inverse);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var type = this.classifySexpr(block);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (type === 'helper') {</span>
<span class="cstat-no" title="statement not covered" >      this.helperSexpr(block, program, inverse);</span>
    } else <span class="cstat-no" title="statement not covered" >if (type === 'simple') {</span>
<span class="cstat-no" title="statement not covered" >      this.simpleSexpr(block);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.opcode('blockValue', block.path.original);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.ambiguousSexpr(block, program, inverse);</span>
&nbsp;
      // now that the simple mustache is resolved, we need to
      // evaluate it by executing `blockHelperMissing`
<span class="cstat-no" title="statement not covered" >      this.opcode('pushProgram', program);</span>
...
&nbsp;
  DecoratorBlock: <span class="fstat-no" title="function not covered" >function DecoratorBlock(decorator) {</span>
<span class="cstat-no" title="statement not covered" >    var program = decorator.program &amp;&amp; this.compileProgram(decorator.program);</span>
<span class="cstat-no" title="statement not covered" >    var params = this.setupFullMustacheParams(decorator, program, undefined),</span>
        path = decorator.path;
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.useDecorators = true;</span>
<span class="cstat-no" title="statement not covered" >    this.opcode('registerDecorator', params.length, path.original);</span>
  },
&nbsp;
  PartialStatement: <span class="fstat-no" title="function not covered" >function PartialStatement(partial) {</span>
<span class="cstat-no" title="statement not covered" >    this.usePartial = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var program = partial.program;</span>
<span class="cstat-no" title="statement not covered" >    if (program) {</span>
<span class="cstat-no" title="statement not covered" >      program = this.compileProgram(partial.program);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var params = partial.params;</span>
<span class="cstat-no" title="statement not covered" >    if (params.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      throw new _exception2['default']('Unsupported number of partial arguments: ' + params.length, partial);</span>
    } else <span class="cstat-no" title="statement not covered" >if (!params.length) {</span>
<span class="cstat-no" title="statement not covered" >      if (this.options.explicitPartialContext) {</span>
<span class="cstat-no" title="statement not covered" >        this.opcode('pushLiteral', 'undefined');</span>
      } else {
<span class="cstat-no" title="statement not covered" >        params.push({ type: 'PathExpression', parts: [], depth: 0 });</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var partialName = partial.name.original,</span>
        isDynamic = partial.name.type === 'SubExpression';
<span class="cstat-no" title="statement not covered" >    if (isDynamic) {</span>
<span class="cstat-no" title="statement not covered" >      this.accept(partial.name);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.setupFullMustacheParams(partial, program, undefined, true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var indent = partial.indent || '';</span>
<span class="cstat-no" title="statement not covered" >    if (this.options.preventIndent &amp;&amp; indent) {</span>
<span class="cstat-no" title="statement not covered" >      this.opcode('appendContent', indent);</span>
<span class="cstat-no" title="statement not covered" >      indent = '';</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.opcode('invokePartial', isDynamic, partialName, indent);</span>
<span class="cstat-no" title="statement not covered" >    this.opcode('append');</span>
  },
  PartialBlockStatement: <span class="fstat-no" title="function not covered" >function PartialBlockStatement(partialBlock) {</span>
<span class="cstat-no" title="statement not covered" >    this.PartialStatement(partialBlock);</span>
  },
&nbsp;
  MustacheStatement: <span class="fstat-no" title="function not covered" >function MustacheStatement(mustache) {</span>
<span class="cstat-no" title="statement not covered" >    this.SubExpression(mustache);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.opcode('append');</span>
  ...
  Decorator: <span class="fstat-no" title="function not covered" >function Decorator(decorator) {</span>
<span class="cstat-no" title="statement not covered" >    this.DecoratorBlock(decorator);</span>
  },
&nbsp;
  ContentStatement: <span class="fstat-no" title="function not covered" >function ContentStatement(content) {</span>
<span class="cstat-no" title="statement not covered" >    if (content.value) {</span>
<span class="cstat-no" title="statement not covered" >      this.opcode('appendContent', content.value);</span>
    }
  },
&nbsp;
  CommentStatement: <span class="fstat-no" title="function not covered" >function CommentStatement() {</span>},
&nbsp;
  SubExpression: <span class="fstat-no" title="function not covered" >function SubExpression(sexpr) {</span>
<span class="cstat-no" title="statement not covered" >    transformLiteralToPath(sexpr);</span>
...
<span class="cstat-no" title="statement not covered" >      this.ambiguousSexpr(sexpr);</span>
  ...
  ambiguousSexpr: <span class="fstat-no" title="function not covered" >function ambiguousSexpr(sexpr, program, inverse) {</span>
<span class="cstat-no" title="statement not covered" >    var path = sexpr.path,</span>
        name = path.parts[0],
        isBlock = program != null || inverse != null;
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.opcode('getContext', path.depth);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.opcode('pushProgram', program);</span>
<span class="cstat-no" title="statement not covered" >    this.opcode('pushProgram', inverse);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    path.strict = true;</span>
<span class="cstat-no" title="statement not covered" >    this.accept(path);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.opcode('invokeAmbiguous', name, isBlock);</span>
  },
&nbsp;
  simpleSexpr: <span class="fstat-no" title="function not covered" >function simpleSexpr(sexpr) {</span>
<span class="cstat-no" title="statement not covered" >    var path = sexpr.path;</span>
<span class="cstat-no" title="statement not covered" >    path.strict = true;</span>
<span class="cstat-no" title="statement not covered" >    this.accept(path);</span>
...
&nbsp;
  helperSexpr: <span class="fstat-no" title="function not covered" >function helperSexpr(sexpr, program, inverse) {</span>
...
<span class="cstat-no" title="statement not covered" >      throw new _exception2['default']('You specified knownHelpersOnly, but used the unknown helper ' + name, sexpr);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      path.strict = true;</span>
<span class="cstat-no" title="statement not covered" >      path.falsy = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.accept(path);</span>
<span class="cstat-no" title="statement not covered" >      this.opcode('invokeHelper', params.length, path.original, _ast2['default'].helpers.simpleId(path));</span>
    }
  },
&nbsp;
  PathExpression: <span class="fstat-no" title="function not covered" >function PathExpression(path) {</span>
<span class="cstat-no" title="statement not covered" >    this.addDepth(path.depth);</span>
<span class="cstat-no" title="statement not covered" >    this.opcode('getContext', path.depth);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var name = path.parts[0],</span>
        scoped = _ast2['default'].helpers.scopedId(path),
        blockParamId = !path.depth &amp;&amp; !scoped &amp;&amp; this.blockParamIndex(name);
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (blockParamId) {</span>
<span class="cstat-no" title="statement not covered" >      this.opcode('lookupBlockParam', blockParamId, path.parts);</span>
...
<span class="cstat-no" title="statement not covered" >      this.opcode('pushContext');</span>
    } else <span class="cstat-no" title="statement not covered" >if (path.data) {</span>
<span class="cstat-no" title="statement not covered" >      this.options.data = true;</span>
<span class="cstat-no" title="statement not covered" >      this.opcode('lookupData', path.depth, path.parts, path.strict);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.opcode('lookupOnContext', path.parts, path.falsy, path.strict, scoped);</span>
    }
  },
&nbsp;
  StringLiteral: <span class="fstat-no" title="function not covered" >function StringLiteral(string) {</span>
<span class="cstat-no" title="statement not covered" >    this.opcode('pushString', string.value);</span>
  },
&nbsp;
  NumberLiteral: <span class="fstat-no" title="function not covered" >function NumberLiteral(number) {</span>
<span class="cstat-no" title="statement not covered" >    this.opcode('pushLiteral', number.value);</span>
  },
&nbsp;
  BooleanLiteral: <span class="fstat-no" title="function not covered" >function BooleanLiteral(bool) {</span>
<span class="cstat-no" title="statement not covered" >    this.opcode('pushLiteral', bool.value);</span>
  },
&nbsp;
  UndefinedLiteral: <span class="fstat-no" title="function not covered" >function UndefinedLiteral() {</span>
<span class="cstat-no" title="statement not covered" >    this.opcode('pushLiteral', 'undefined');</span>
  },
&nbsp;
  NullLiteral: <span class="fstat-no" title="function not covered" >function NullLiteral() {</span>
<span class="cstat-no" title="statement not covered" >    this.opcode('pushLiteral', 'null');</span>
  },
&nbsp;
  Hash: <span class="fstat-no" title="function not covered" >function Hash(hash) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.pushParam(pairs[i].value);</span>
    }
<span class="cstat-no" title="statement not covered" >    while (i--) {</span>
<span class="cstat-no" title="statement not covered" >      this.opcode('assignToHash', pairs[i].key);</span>
    }
<span class="cstat-no" title="statement not covered" >    this.opcode('popHash');</span>
  },
&nbsp;
  // HELPERS
  opcode: <span class="fstat-no" title="function not covered" >function opcode(name) {</span>
<span class="cstat-no" title="statement not covered" >    this.opcodes.push({ opcode: name, args: slice.call(arguments, 1), loc: this.sourceNode[0].loc });</span>
  },
&nbsp;
  addDepth: <span class="fstat-no" title="function not covered" >function addDepth(depth) {</span>
<span class="cstat-no" title="statement not covered" >    if (!depth) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.useDepths = true;</span>
  },
&nbsp;
  classifySexpr: <span class="fstat-no" title="function not covered" >function classifySexpr(sexpr) {</span>
<span class="cstat-no" title="statement not covered" >    var isSimple = _ast2['default'].helpers.simpleId(sexpr.path);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var isBlockParam = isSimple &amp;&amp; !!this.blockParamIndex(sexpr.path.parts[0]);</span>
&nbsp;
    // a mustache is an eligible helper if:
    // * its id is simple (a single part, not `this` or `..`)
<span class="cstat-no" title="statement not covered" >    var isHelper = !isBlockParam &amp;&amp; _ast2['default'].helpers.helperExpression(sexpr);</span>
&nbsp;
    // if a mustache is an eligible helper but not a definite
    // helper, it is ambiguous, and will be resolved in a later
    // pass or at runtime.
<span class="cstat-no" title="statement not covered" >    var isEligible = !isBlockParam &amp;&amp; (isHelper || isSimple);</span>
&nbsp;
    // if ambiguous, we can possibly resolve the ambiguity now
    // An eligible helper is one that does not have a complex path, i.e. `this.foo`, `../foo` etc.
<span class="cstat-no" title="statement not covered" >    if (isEligible &amp;&amp; !isHelper) {</span>
<span class="cstat-no" title="statement not covered" >      var _name2 = sexpr.path.parts[0],</span>
          options = this.options;
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (options.knownHelpers[_name2]) {</span>
...
<span class="cstat-no" title="statement not covered" >      return 'helper';</span>
    } else <span class="cstat-no" title="statement not covered" >if (isEligible) {</span>
...
&nbsp;
  pushParams: <span class="fstat-no" title="function not covered" >function pushParams(params) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = params.length; i &lt; l; i++) {</span>
<span class="cstat-no" title="statement not covered" >      this.pushParam(params[i]);</span>
    }
  },
&nbsp;
  pushParam: <span class="fstat-no" title="function not covered" >function pushParam(val) {</span>
<span class="cstat-no" title="statement not covered" >    var value = val.value != null ? val.value : val.original || '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.stringParams) {</span>
<span class="cstat-no" title="statement not covered" >      if (value.replace) {</span>
<span class="cstat-no" title="statement not covered" >        value = value.replace(/^(\.?\.\/)*/g, '').replace(/\//g, '.');</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.opcode('pushStringParam', value, val.type);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (val.type === 'SubExpression') {</span>
...
<span class="cstat-no" title="statement not covered" >        var blockParamIndex = undefined;</span>
<span class="cstat-no" title="statement not covered" >        if (val.parts &amp;&amp; !_ast2['default'].helpers.scopedId(val) &amp;&amp; !val.depth) {</span>
<span class="cstat-no" title="statement not covered" >          blockParamIndex = this.blockParamIndex(val.parts[0]);</span>
        }
<span class="cstat-no" title="statement not covered" >        if (blockParamIndex) {</span>
<span class="cstat-no" title="statement not covered" >          var blockParamChild = val.parts.slice(1).join('.');</span>
<span class="cstat-no" title="statement not covered" >          this.opcode('pushId', 'BlockParam', blockParamIndex, blockParamChild);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          value = val.original || value;</span>
<span class="cstat-no" title="statement not covered" >          if (value.replace) {</span>
<span class="cstat-no" title="statement not covered" >            value = value.replace(/^this(?:\.|$)/, '').replace(/^\.\//, '').replace(/^\.$/, '');</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          this.opcode('pushId', val.type, value);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      this.accept(val);</span>
    }
...
&nbsp;
  setupFullMustacheParams: <span class="fstat-no" title="function not covered" >function setupFullMustacheParams(sexpr, program, inverse, omitEmpty) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.accept(sexpr.hash);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.opcode('emptyHash', omitEmpty);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return params;</span>
  },
&nbsp;
  blockParamIndex: <span class="fstat-no" title="function not covered" >function blockParamIndex(name) {</span>
<span class="cstat-no" title="statement not covered" >    for (var depth = 0, len = this.options.blockParams.length; depth &lt; len; depth++) {</span>
<span class="cstat-no" title="statement not covered" >      var blockParams = this.options.blockParams[depth],</span>
          param = blockParams &amp;&amp; _utils.indexOf(blockParams, name);
<span class="cstat-no" title="statement not covered" >      if (blockParams &amp;&amp; param &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >        return [depth, param];</span>
      }
    }
  }
};
...
<span class="cstat-no" title="statement not covered" >  if (input == null || typeof input !== 'string' &amp;&amp; input.type !== 'Program') {</span>
<span class="cstat-no" title="statement not covered" >    throw new _exception2['default']('You must pass a string or Handlebars AST to Handlebars.precompile. You passed ' + input);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  if (options.compat) {</span>
<span class="cstat-no" title="statement not covered" >    options.useDepths = true;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var ast = env.parse(input, options),</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function compile(input, options, env) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (input == null || typeof input !== 'string' &amp;&amp; input.type !== 'Program') {</span>
<span class="cstat-no" title="statement not covered" >    throw new _exception2['default']('You must pass a string or Handlebars AST to Handlebars.compile. You passed ' + input);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!('data' in options)) {</span>
<span class="cstat-no" title="statement not covered" >    options.data = true;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var compiled = undefined;</span>
&nbsp;
...
<span class="fstat-no" title="function not covered" >  function ret(context, execOptions) {</span>
...
<span class="cstat-no" title="statement not covered" >    return compiled.call(this, context, execOptions);</span>
  }
<span class="cstat-no" title="statement not covered" >  ret._setup = <span class="fstat-no" title="function not covered" >function (setupOptions) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (!compiled) {</span>
<span class="cstat-no" title="statement not covered" >      compiled = compileInput();</span>
    }
<span class="cstat-no" title="statement not covered" >    return compiled._setup(setupOptions);</span>
  };
<span class="cstat-no" title="statement not covered" >  ret._child = <span class="fstat-no" title="function not covered" >function (i, data, blockParams, depths) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (!compiled) {</span>
<span class="cstat-no" title="statement not covered" >      compiled = compileInput();</span>
    }
<span class="cstat-no" title="statement not covered" >    return compiled._child(i, data, blockParams, depths);</span>
  };
<span class="cstat-no" title="statement not covered" >  return ret;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function argEquals(a, b) {</span>
<span class="cstat-no" title="statement not covered" >  if (a === b) {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (_utils.isArray(a) &amp;&amp; _utils.isArray(b) &amp;&amp; a.length === b.length) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; a.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >      if (!argEquals(a[i], b[i])) {</span>
<span class="cstat-no" title="statement not covered" >        return false;</span>
      }
    }
<span class="cstat-no" title="statement not covered" >    return true;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function transformLiteralToPath(sexpr) {</span>
<span class="cstat-no" title="statement not covered" >  if (!sexpr.path.parts) {</span>
<span class="cstat-no" title="statement not covered" >    var literal = sexpr.path;</span>
    // Casting to string here to make false and 0 literal values play nicely with the rest
    // of the system.
<span class="cstat-no" title="statement not covered" >    sexpr.path = {</span>
      type: 'PathExpression',
      data: false,
      depth: 0,
