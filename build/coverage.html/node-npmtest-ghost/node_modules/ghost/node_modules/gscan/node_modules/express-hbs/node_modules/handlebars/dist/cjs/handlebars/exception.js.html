...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/exception.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/exception.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/</a> &#187; exception.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var loc = node &amp;&amp; node.loc,</span>
      line = undefined,
      column = undefined;
<span class="cstat-no" title="statement not covered" >  if (loc) {</span>
<span class="cstat-no" title="statement not covered" >    line = loc.start.line;</span>
<span class="cstat-no" title="statement not covered" >    column = loc.start.column;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    message += ' - ' + line + ':' + column;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    Error.captureStackTrace(this, Exception);</span>
  }
&nbsp;
...
<span class="cstat-skip" title="statement not covered" >        Object.defineProperty(this, 'column', { value: column });</span>
      } else {
<span class="cstat-skip" title="statement not covered" >        this.column = column;</span>
      }
    }
  } catch (nop) {
