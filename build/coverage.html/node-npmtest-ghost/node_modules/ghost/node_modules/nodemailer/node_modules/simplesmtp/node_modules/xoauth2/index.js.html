...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/node_modules/nodemailer/node_modules/simplesmtp/node_modules/xoauth2/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/node_modules/nodemailer/node_modules/simplesmtp/node_modules/xoauth2/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/node_modules/nodemailer/node_modules/simplesmtp/node_modules/xoauth2/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.timeout = this.options.timeout &amp;&amp; Date.now() + ((Number(this.options.timeout) || 0) - 1) * 1000 || 0;</span>
}
...
<span class="cstat-no" title="statement not covered" >    this.timeout = timeout &amp;&amp; Date.now() + ((Number(timeout) || 0) - 1) * 1000 || 0;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        postRequest(this.options.accessUrl, payload, (<span class="fstat-no" title="function not covered" >function(error, response, body){</span></span>
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function postRequest(url, payload, callback){</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var req = (options.protocol=="https:"?https:http).request(options, <span class="fstat-no" title="function not covered" >function(res) {</span></span>
<span class="cstat-no" title="statement not covered" >        var data = [];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return callback(null, res, Buffer.concat(data));</span>
        });
&nbsp;
