...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/core/server/utils/packages/filter-packages.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/core/server/utils/packages/filter-packages.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/core/server/utils/packages/</a> &#187; filter-packages.js</div>
</div>
<div class="body">
 ...
 */
filterPackages = <span class="fstat-no" title="function not covered" >function filterPackages(packages, active) {</span>
    // turn active into an array (so themes and apps can be checked the same)
<span class="cstat-no" title="statement not covered" >    if (!Array.isArray(active)) {</span>
<span class="cstat-no" title="statement not covered" >        active = [active];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _.reduce(packages, <span class="fstat-no" title="function not covered" >function (result, pkg, key) {</span></span>
<span class="cstat-no" title="statement not covered" >        var item = {};</span>
<span class="cstat-no" title="statement not covered" >        if (!key.match(notAPackageRegex)) {</span>
...
<span class="cstat-no" title="statement not covered" >            if (_.indexOf(active, key) !== -1) {</span>
<span class="cstat-no" title="statement not covered" >                item.active = true;</span>
            }
&nbsp;
