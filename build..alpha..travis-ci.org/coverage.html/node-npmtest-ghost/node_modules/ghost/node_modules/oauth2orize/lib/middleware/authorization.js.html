...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/node_modules/oauth2orize/lib/middleware/authorization.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/node_modules/oauth2orize/lib/middleware/authorization.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/node_modules/oauth2orize/lib/middleware/</a> &#187; authorization.js</div>
</div>
<div class="body">
 ...
 * @api protected
 */
module.exports = <span class="fstat-no" title="function not covered" >function(server, options, validate, immediate) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (!req.session) { <span class="cstat-no" title="statement not covered" >return next(new Error('OAuth2orize requires session support. Did you forget app.use(express.session(...))?')); </span>}</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            server._respond(req.oauth2, res, <span class="fstat-no" title="function not covered" >function(err) {</span></span>
<span class="cstat-no" title="statement not covered" >              if (err) { <span class="cstat-no" title="statement not covered" >return next(err); </span>}</span>
