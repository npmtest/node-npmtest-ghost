...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/ast.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/ast.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/</a> &#187; ast.js</div>
</div>
<div class="body">
...
var AST = {
  ...
  helpers: {
    ...
    helperExpression: <span class="fstat-no" title="function not covered" >function helperExpression(node) {</span>
<span class="cstat-no" title="statement not covered" >      return node.type === 'SubExpression' || (node.type === 'MustacheStatement' || node.type === 'BlockStatement') &amp;&amp; !!(node.params &amp;&amp; node.params.length || node.hash);</span>
    },
&nbsp;
    scopedId: <span class="fstat-no" title="function not covered" >function scopedId(path) {</span>
<span class="cstat-no" title="statement not covered" >      return (/^\.|this\b/.test(path.original)</span>
      );
    },
&nbsp;
    // an ID is simple if it only has one part, and that part is not
    // `..` or `this`.
    simpleId: <span class="fstat-no" title="function not covered" >function simpleId(path) {</span>
<span class="cstat-no" title="statement not covered" >      return path.parts.length === 1 &amp;&amp; !AST.helpers.scopedId(path) &amp;&amp; !path.depth;</span>
    }
  }
};
&nbsp;
