...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/printer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/printer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/</a> &#187; printer.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function PrintVisitor() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  out += string + '\n';</span>
...
<span class="cstat-no" title="statement not covered" >  var out = '',</span>
      ...
      l = undefined;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (program.blockParams) {</span>
<span class="cstat-no" title="statement not covered" >    var blockParams = 'BLOCK PARAMS: [';</span>
<span class="cstat-no" title="statement not covered" >    for (i = 0, l = program.blockParams.length; i &lt; l; i++) {</span>
<span class="cstat-no" title="statement not covered" >      blockParams += ' ' + program.blockParams[i];</span>
    }
<span class="cstat-no" title="statement not covered" >    blockParams += ' ]';</span>
<span class="cstat-no" title="statement not covered" >    out += this.pad(blockParams);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (i = 0, l = body.length; i &lt; l; i++) {</span>
<span class="cstat-no" title="statement not covered" >    out += this.accept(body[i]);</span>
  }
&nbsp;
...
&nbsp;
PrintVisitor.prototype.MustacheStatement = <span class="fstat-no" title="function not covered" >function (mustache) {</span>
<span class="cstat-no" title="statement not covered" >  return this.pad('{{ ' + this.SubExpression(mustache) + ' }}');</span>
};
PrintVisitor.prototype.Decorator = <span class="fstat-no" title="function not covered" >function (mustache) {</span>
<span class="cstat-no" title="statement not covered" >  return this.pad('{{ DIRECTIVE ' + this.SubExpression(mustache) + ' }}');</span>
};
&nbsp;
PrintVisitor.prototype.BlockStatement = PrintVisitor.prototype.DecoratorBlock = <span class="fstat-no" title="function not covered" >function (block) {</span>
<span class="cstat-no" title="statement not covered" >  var out = '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  out += this.pad((block.type === 'DecoratorBlock' ? 'DIRECTIVE ' : '') + 'BLOCK:');</span>
<span class="cstat-no" title="statement not covered" >  this.padding++;</span>
<span class="cstat-no" title="statement not covered" >  out += this.pad(this.SubExpression(block));</span>
<span class="cstat-no" title="statement not covered" >  if (block.program) {</span>
<span class="cstat-no" title="statement not covered" >    out += this.pad('PROGRAM:');</span>
<span class="cstat-no" title="statement not covered" >    this.padding++;</span>
<span class="cstat-no" title="statement not covered" >    out += this.accept(block.program);</span>
<span class="cstat-no" title="statement not covered" >    this.padding--;</span>
  }
...
<span class="cstat-no" title="statement not covered" >    out += this.pad('{{^}}');</span>
<span class="cstat-no" title="statement not covered" >    this.padding++;</span>
<span class="cstat-no" title="statement not covered" >    out += this.accept(block.inverse);</span>
<span class="cstat-no" title="statement not covered" >    this.padding--;</span>
<span class="cstat-no" title="statement not covered" >    if (block.program) {</span>
<span class="cstat-no" title="statement not covered" >      this.padding--;</span>
    }
...
&nbsp;
PrintVisitor.prototype.PartialStatement = <span class="fstat-no" title="function not covered" >function (partial) {</span>
<span class="cstat-no" title="statement not covered" >  var content = 'PARTIAL:' + partial.name.original;</span>
<span class="cstat-no" title="statement not covered" >  if (partial.params[0]) {</span>
<span class="cstat-no" title="statement not covered" >    content += ' ' + this.accept(partial.params[0]);</span>
  }
...
PrintVisitor.prototype.PartialBlockStatement = <span class="fstat-no" title="function not covered" >function (partial) {</span>
<span class="cstat-no" title="statement not covered" >  var content = 'PARTIAL BLOCK:' + partial.name.original;</span>
<span class="cstat-no" title="statement not covered" >  if (partial.params[0]) {</span>
<span class="cstat-no" title="statement not covered" >    content += ' ' + this.accept(partial.params[0]);</span>
  }
<span class="cstat-no" title="statement not covered" >  if (partial.hash) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  content += ' ' + this.pad('PROGRAM:');</span>
<span class="cstat-no" title="statement not covered" >  this.padding++;</span>
<span class="cstat-no" title="statement not covered" >  content += this.accept(partial.program);</span>
<span class="cstat-no" title="statement not covered" >  this.padding--;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.pad('{{&gt; ' + content + ' }}');</span>
};
&nbsp;
PrintVisitor.prototype.ContentStatement = <span class="fstat-no" title="function not covered" >function (content) {</span>
<span class="cstat-no" title="statement not covered" >  return this.pad("CONTENT[ '" + content.value + "' ]");</span>
};
&nbsp;
PrintVisitor.prototype.CommentStatement = <span class="fstat-no" title="function not covered" >function (comment) {</span>
<span class="cstat-no" title="statement not covered" >  return this.pad("{{! '" + comment.value + "' }}");</span>
};
&nbsp;
PrintVisitor.prototype.SubExpression = <span class="fstat-no" title="function not covered" >function (sexpr) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.accept(sexpr.path) + ' ' + params + hash;</span>
};
&nbsp;
PrintVisitor.prototype.PathExpression = <span class="fstat-no" title="function not covered" >function (id) {</span>
<span class="cstat-no" title="statement not covered" >  var path = id.parts.join('/');</span>
<span class="cstat-no" title="statement not covered" >  return (id.data ? '@' : '') + 'PATH:' + path;</span>
};
&nbsp;
PrintVisitor.prototype.StringLiteral = <span class="fstat-no" title="function not covered" >function (string) {</span>
<span class="cstat-no" title="statement not covered" >  return '"' + string.value + '"';</span>
};
&nbsp;
PrintVisitor.prototype.NumberLiteral = <span class="fstat-no" title="function not covered" >function (number) {</span>
<span class="cstat-no" title="statement not covered" >  return 'NUMBER{' + number.value + '}';</span>
};
&nbsp;
PrintVisitor.prototype.BooleanLiteral = <span class="fstat-no" title="function not covered" >function (bool) {</span>
<span class="cstat-no" title="statement not covered" >  return 'BOOLEAN{' + bool.value + '}';</span>
};
&nbsp;
PrintVisitor.prototype.UndefinedLiteral = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return 'UNDEFINED';</span>
};
&nbsp;
PrintVisitor.prototype.NullLiteral = <span class="fstat-no" title="function not covered" >function () {</span>
...
<span class="cstat-no" title="statement not covered" >    joinedPairs.push(this.accept(pairs[i]));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return 'HASH{' + joinedPairs.join(', ') + '}';</span>
};
PrintVisitor.prototype.HashPair = <span class="fstat-no" title="function not covered" >function (pair) {</span>
<span class="cstat-no" title="statement not covered" >  return pair.key + '=' + this.accept(pair.value);</span>
};
