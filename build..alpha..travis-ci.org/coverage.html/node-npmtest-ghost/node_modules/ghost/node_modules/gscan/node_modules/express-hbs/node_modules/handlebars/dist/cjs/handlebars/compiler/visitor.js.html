...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/visitor.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/visitor.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/compiler/</a> &#187; visitor.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  acceptKey: <span class="fstat-no" title="function not covered" >function acceptKey(node, name) {</span>
<span class="cstat-no" title="statement not covered" >    var value = this.accept(node[name]);</span>
<span class="cstat-no" title="statement not covered" >    if (this.mutating) {</span>
      // Hacky sanity check: This may have a few false positives for type for the helper
      // methods but will generally do the right thing without a lot of overhead.
<span class="cstat-no" title="statement not covered" >      if (value &amp;&amp; !Visitor.prototype[value.type]) {</span>
<span class="cstat-no" title="statement not covered" >        throw new _exception2['default']('Unexpected node type "' + value.type + '" found when accepting ' + name + ' on ' + node.type);</span>
      }
...
&nbsp;
  ...
  acceptRequired: <span class="fstat-no" title="function not covered" >function acceptRequired(node, name) {</span>
<span class="cstat-no" title="statement not covered" >    this.acceptKey(node, name);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!node[name]) {</span>
<span class="cstat-no" title="statement not covered" >      throw new _exception2['default'](node.type + ' requires ' + name);</span>
    }
  },
&nbsp;
  // Traverses a given array. If mutating, empty respnses will be removed
  // for child elements.
  acceptArray: <span class="fstat-no" title="function not covered" >function acceptArray(array) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = array.length; i &lt; l; i++) {</span>
<span class="cstat-no" title="statement not covered" >      this.acceptKey(array, i);</span>
&nbsp;
...
&nbsp;
  accept: <span class="fstat-no" title="function not covered" >function accept(object) {</span>
<span class="cstat-no" title="statement not covered" >    if (!object) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    /* istanbul ignore next: Sanity code */
<span class="cstat-skip" title="statement not covered" >    if (!this[object.type]) {</span>
<span class="cstat-skip" title="statement not covered" >      throw new _exception2['default']('Unknown type: ' + object.type, object);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.current) {</span>
<span class="cstat-no" title="statement not covered" >      this.parents.unshift(this.current);</span>
    }
<span class="cstat-no" title="statement not covered" >    this.current = object;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var ret = this[object.type](object);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.current = this.parents.shift();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.mutating || ret) {</span>
...
<span class="cstat-no" title="statement not covered" >    this.acceptArray(program.body);</span>
  },
&nbsp;
...
&nbsp;
  ...
  PartialBlockStatement: <span class="fstat-no" title="function not covered" >function PartialBlockStatement(partial) {</span>
<span class="cstat-no" title="statement not covered" >    visitPartial.call(this, partial);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.acceptKey(partial, 'program');</span>
  },
&nbsp;
  ContentStatement: <span class="fstat-no" title="function not covered" >function ContentStatement() /* content */{</span>},
  CommentStatement: <span class="fstat-no" title="function not covered" >function CommentStatement() /* comment */{</span>},
&nbsp;
...
&nbsp;
  ...
  UndefinedLiteral: <span class="fstat-no" title="function not covered" >function UndefinedLiteral() /* literal */{</span>},
  NullLiteral: <span class="fstat-no" title="function not covered" >function NullLiteral() /* literal */{</span>},
&nbsp;
  Hash: <span class="fstat-no" title="function not covered" >function Hash(hash) {</span>
<span class="cstat-no" title="statement not covered" >    this.acceptArray(hash.pairs);</span>
  },
  HashPair: <span class="fstat-no" title="function not covered" >function HashPair(pair) {</span>
<span class="cstat-no" title="statement not covered" >    this.acceptRequired(pair, 'value');</span>
  }
};
&nbsp;
<span class="fstat-no" title="function not covered" >function visitSubExpression(mustache) {</span>
<span class="cstat-no" title="statement not covered" >  this.acceptRequired(mustache, 'path');</span>
<span class="cstat-no" title="statement not covered" >  this.acceptArray(mustache.params);</span>
<span class="cstat-no" title="statement not covered" >  this.acceptKey(mustache, 'hash');</span>
}
<span class="fstat-no" title="function not covered" >function visitBlock(block) {</span>
<span class="cstat-no" title="statement not covered" >  visitSubExpression.call(this, block);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.acceptKey(block, 'program');</span>
<span class="cstat-no" title="statement not covered" >  this.acceptKey(block, 'inverse');</span>
}
<span class="fstat-no" title="function not covered" >function visitPartial(partial) {</span>
<span class="cstat-no" title="statement not covered" >  this.acceptRequired(partial, 'name');</span>
<span class="cstat-no" title="statement not covered" >  this.acceptArray(partial.params);</span>
<span class="cstat-no" title="statement not covered" >  this.acceptKey(partial, 'hash');</span>
}
&nbsp;
