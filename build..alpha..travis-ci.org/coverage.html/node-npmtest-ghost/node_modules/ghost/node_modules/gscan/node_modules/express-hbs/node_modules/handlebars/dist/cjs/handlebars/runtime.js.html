...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/runtime.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/runtime.js</span></h1>
    <h2>
        
        Statements: <span class="metric">22.35% <small>(38 / 170)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">9.21% <small>(14 / 152)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">8.7% <small>(2 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">17.5% <small>(28 / 160)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric">9 statements, 8 branches</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ghost/node_modules/ghost/node_modules/gscan/node_modules/express-hbs/node_modules/handlebars/dist/cjs/handlebars/</a> &#187; runtime.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    if (compilerRevision &lt; currentRevision) {</span>
<span class="cstat-no" title="statement not covered" >      var runtimeVersions = _base.REVISION_CHANGES[currentRevision],</span>
          compilerVersions = _base.REVISION_CHANGES[compilerRevision];
<span class="cstat-no" title="statement not covered" >      throw new _exception2['default']('Template was precompiled with an older version of Handlebars than the current runtime. ' + 'Please update your precompiler to a newer version (' + runtimeVersions + ') or downgrade your runtime to an older version (' + compilerVersions + ').');</span>
    } else {
      // Use the embedded version info since the runtime doesn't know about this revision yet
<span class="cstat-no" title="statement not covered" >      throw new _exception2['default']('Template was precompiled with a newer version of Handlebars than the current runtime. ' + 'Please update your runtime to a newer version (' + compilerInfo[1] + ').');</span>
    }
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function template(templateSpec, env) {</span>
  /* istanbul ignore next */
<span class="cstat-skip" title="statement not covered" >  if (!env) {</span>
<span class="cstat-skip" title="statement not covered" >    throw new _exception2['default']('No environment passed to template');</span>
  }
<span class="cstat-no" title="statement not covered" >  if (!templateSpec || !templateSpec.main) {</span>
<span class="cstat-no" title="statement not covered" >    throw new _exception2['default']('Unknown template object: ' + typeof templateSpec);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  templateSpec.main.decorator = templateSpec.main_d;</span>
&nbsp;
  // Note: Using env.VM references rather than local var references throughout this section to allow
  // for external users to override these as psuedo-supported APIs.
<span class="cstat-no" title="statement not covered" >  env.VM.checkRevision(templateSpec.compiler);</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  function invokePartialWrapper(partial, context, options) {</span>
<span class="cstat-no" title="statement not covered" >    if (options.hash) {</span>
<span class="cstat-no" title="statement not covered" >      context = Utils.extend({}, context, options.hash);</span>
<span class="cstat-no" title="statement not covered" >      if (options.ids) {</span>
<span class="cstat-no" title="statement not covered" >        options.ids[0] = true;</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    partial = env.VM.resolvePartial.call(this, partial, context, options);</span>
<span class="cstat-no" title="statement not covered" >    var result = env.VM.invokePartial.call(this, partial, context, options);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (result == null &amp;&amp; env.compile) {</span>
<span class="cstat-no" title="statement not covered" >      options.partials[options.name] = env.compile(partial, templateSpec.compilerOptions, env);</span>
<span class="cstat-no" title="statement not covered" >      result = options.partials[options.name](context, options);</span>
    }
...
<span class="cstat-no" title="statement not covered" >        var lines = result.split('\n');</span>
<span class="cstat-no" title="statement not covered" >        for (var i = 0, l = lines.length; i &lt; l; i++) {</span>
<span class="cstat-no" title="statement not covered" >          if (!lines[i] &amp;&amp; i + 1 === l) {</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          lines[i] = options.indent + lines[i];</span>
        }
<span class="cstat-no" title="statement not covered" >        result = lines.join('\n');</span>
      }
<span class="cstat-no" title="statement not covered" >      return result;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      throw new _exception2['default']('The partial ' + options.name + ' could not be compiled when running in runtime-only mode');</span>
    }
  }
&nbsp;
  // Just add water
<span class="cstat-no" title="statement not covered" >  var container = {</span>
    strict: <span class="fstat-no" title="function not covered" >function strict(obj, name) {</span>
<span class="cstat-no" title="statement not covered" >      if (!(name in obj)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new _exception2['default']('"' + name + '" not defined in ' + obj);</span>
      }
<span class="cstat-no" title="statement not covered" >      return obj[name];</span>
    },
    lookup: <span class="fstat-no" title="function not covered" >function lookup(depths, name) {</span>
<span class="cstat-no" title="statement not covered" >      var len = depths.length;</span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >        if (depths[i] &amp;&amp; depths[i][name] != null) {</span>
<span class="cstat-no" title="statement not covered" >          return depths[i][name];</span>
        }
      }
    },
    lambda: <span class="fstat-no" title="function not covered" >function lambda(current, context) {</span>
<span class="cstat-no" title="statement not covered" >      return typeof current === 'function' ? current.call(context) : current;</span>
    },
&nbsp;
    escapeExpression: Utils.escapeExpression,
    invokePartial: invokePartialWrapper,
&nbsp;
    fn: <span class="fstat-no" title="function not covered" >function fn(i) {</span>
<span class="cstat-no" title="statement not covered" >      var ret = templateSpec[i];</span>
<span class="cstat-no" title="statement not covered" >      ret.decorator = templateSpec[i + '_d'];</span>
<span class="cstat-no" title="statement not covered" >      return ret;</span>
    },
&nbsp;
    programs: [],
    program: <span class="fstat-no" title="function not covered" >function program(i, data, declaredBlockParams, blockParams, depths) {</span>
<span class="cstat-no" title="statement not covered" >      var programWrapper = this.programs[i],</span>
          fn = this.fn(i);
<span class="cstat-no" title="statement not covered" >      if (data || depths || blockParams || declaredBlockParams) {</span>
<span class="cstat-no" title="statement not covered" >        programWrapper = wrapProgram(this, i, fn, data, declaredBlockParams, blockParams, depths);</span>
      } else <span class="cstat-no" title="statement not covered" >if (!programWrapper) {</span>
<span class="cstat-no" title="statement not covered" >        programWrapper = this.programs[i] = wrapProgram(this, i, fn);</span>
      }
<span class="cstat-no" title="statement not covered" >      return programWrapper;</span>
    },
&nbsp;
    data: <span class="fstat-no" title="function not covered" >function data(value, depth) {</span>
<span class="cstat-no" title="statement not covered" >      while (value &amp;&amp; depth--) {</span>
<span class="cstat-no" title="statement not covered" >        value = value._parent;</span>
      }
<span class="cstat-no" title="statement not covered" >      return value;</span>
    },
    merge: <span class="fstat-no" title="function not covered" >function merge(param, common) {</span>
<span class="cstat-no" title="statement not covered" >      var obj = param || common;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (param &amp;&amp; common &amp;&amp; param !== common) {</span>
<span class="cstat-no" title="statement not covered" >        obj = Utils.extend({}, common, param);</span>
      }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ret(context) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    ret._setup(options);</span>
<span class="cstat-no" title="statement not covered" >    if (!options.partial &amp;&amp; templateSpec.useData) {</span>
<span class="cstat-no" title="statement not covered" >      data = initData(context, data);</span>
    }
<span class="cstat-no" title="statement not covered" >    var depths = undefined,</span>
        blockParams = templateSpec.useBlockParams ? [] : undefined;
<span class="cstat-no" title="statement not covered" >    if (templateSpec.useDepths) {</span>
<span class="cstat-no" title="statement not covered" >      if (options.depths) {</span>
<span class="cstat-no" title="statement not covered" >        depths = context != options.depths[0] ? [context].concat(options.depths) : options.depths;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        depths = [context];</span>
      }
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function main(context /*, options*/) {</span>
<span class="cstat-no" title="statement not covered" >      return '' + templateSpec.main(container, context, container.helpers, container.partials, data, blockParams, depths);</span>
    }
<span class="cstat-no" title="statement not covered" >    main = executeDecorators(templateSpec.main, main, container, options.depths || [], data, blockParams);</span>
<span class="cstat-no" title="statement not covered" >    return main(context, options);</span>
  }
<span class="cstat-no" title="statement not covered" >  ret.isTop = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  ret._setup = <span class="fstat-no" title="function not covered" >function (options) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (!options.partial) {</span>
<span class="cstat-no" title="statement not covered" >      container.helpers = container.merge(options.helpers, env.helpers);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (templateSpec.usePartial) {</span>
<span class="cstat-no" title="statement not covered" >        container.partials = container.merge(options.partials, env.partials);</span>
      }
<span class="cstat-no" title="statement not covered" >      if (templateSpec.usePartial || templateSpec.useDecorators) {</span>
<span class="cstat-no" title="statement not covered" >        container.decorators = container.merge(options.decorators, env.decorators);</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      container.helpers = options.helpers;</span>
<span class="cstat-no" title="statement not covered" >      container.partials = options.partials;</span>
<span class="cstat-no" title="statement not covered" >      container.decorators = options.decorators;</span>
    }
  };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (templateSpec.useBlockParams &amp;&amp; !blockParams) {</span>
<span class="cstat-no" title="statement not covered" >      throw new _exception2['default']('must pass block params');</span>
    }
<span class="cstat-no" title="statement not covered" >    if (templateSpec.useDepths &amp;&amp; !depths) {</span>
<span class="cstat-no" title="statement not covered" >      throw new _exception2['default']('must pass parent depths');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return wrapProgram(container, i, templateSpec[i], data, 0, blockParams, depths);</span>
  };
<span class="cstat-no" title="statement not covered" >  return ret;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function wrapProgram(container, i, fn, data, declaredBlockParams, blockParams, depths) {</span>
<span class="fstat-no" title="function not covered" >  function prog(context) {</span>
<span class="cstat-no" title="statement not covered" >    var options = arguments.length &lt;= 1 || arguments[1] === undefined ? {} : arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var currentDepths = depths;</span>
<span class="cstat-no" title="statement not covered" >    if (depths &amp;&amp; context != depths[0]) {</span>
<span class="cstat-no" title="statement not covered" >      currentDepths = [context].concat(depths);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return fn(container, context, container.helpers, container.partials, options.data || data, blockParams &amp;&amp; [options.blockParams].concat(blockParams), currentDepths);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  prog = executeDecorators(fn, prog, container, depths, data, blockParams);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  prog.program = i;</span>
<span class="cstat-no" title="statement not covered" >  prog.depth = depths ? depths.length : 0;</span>
<span class="cstat-no" title="statement not covered" >  prog.blockParams = declaredBlockParams || 0;</span>
<span class="cstat-no" title="statement not covered" >  return prog;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function resolvePartial(partial, context, options) {</span>
<span class="cstat-no" title="statement not covered" >  if (!partial) {</span>
<span class="cstat-no" title="statement not covered" >    if (options.name === '@partial-block') {</span>
<span class="cstat-no" title="statement not covered" >      var data = options.data;</span>
<span class="cstat-no" title="statement not covered" >      while (data['partial-block'] === noop) {</span>
<span class="cstat-no" title="statement not covered" >        data = data._parent;</span>
      }
<span class="cstat-no" title="statement not covered" >      partial = data['partial-block'];</span>
<span class="cstat-no" title="statement not covered" >      data['partial-block'] = noop;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      partial = options.partials[options.name];</span>
    }
  } else <span class="cstat-no" title="statement not covered" >if (!partial.call &amp;&amp; !options.name) {</span>
    // This is a dynamic partial that returned a string
<span class="cstat-no" title="statement not covered" >    options.name = partial;</span>
<span class="cstat-no" title="statement not covered" >    partial = options.partials[partial];</span>
  }
<span class="cstat-no" title="statement not covered" >  return partial;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function invokePartial(partial, context, options) {</span>
<span class="cstat-no" title="statement not covered" >  options.partial = true;</span>
<span class="cstat-no" title="statement not covered" >  if (options.ids) {</span>
<span class="cstat-no" title="statement not covered" >    options.data.contextPath = options.ids[0] || options.data.contextPath;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var partialBlock = undefined;</span>
<span class="cstat-no" title="statement not covered" >  if (options.fn &amp;&amp; options.fn !== noop) {</span>
<span class="cstat-no" title="statement not covered" >    options.data = _base.createFrame(options.data);</span>
<span class="cstat-no" title="statement not covered" >    partialBlock = options.data['partial-block'] = options.fn;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (partialBlock.partials) {</span>
<span class="cstat-no" title="statement not covered" >      options.partials = Utils.extend({}, options.partials, partialBlock.partials);</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (partial === undefined &amp;&amp; partialBlock) {</span>
<span class="cstat-no" title="statement not covered" >    partial = partialBlock;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (partial === undefined) {</span>
<span class="cstat-no" title="statement not covered" >    throw new _exception2['default']('The partial ' + options.name + ' could not be found');</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function initData(context, data) {</span>
<span class="cstat-no" title="statement not covered" >  if (!data || !('root' in data)) {</span>
<span class="cstat-no" title="statement not covered" >    data = data ? _base.createFrame(data) : {};</span>
<span class="cstat-no" title="statement not covered" >    data.root = context;</span>
  }
<span class="cstat-no" title="statement not covered" >  return data;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function executeDecorators(fn, prog, container, depths, data, blockParams) {</span>
<span class="cstat-no" title="statement not covered" >  if (fn.decorator) {</span>
<span class="cstat-no" title="statement not covered" >    var props = {};</span>
<span class="cstat-no" title="statement not covered" >    prog = fn.decorator(prog, props, container, depths &amp;&amp; depths[0], data, blockParams, depths);</span>
<span class="cstat-no" title="statement not covered" >    Utils.extend(prog, props);</span>
  }
<span class="cstat-no" title="statement not covered" >  return prog;</span>
}
